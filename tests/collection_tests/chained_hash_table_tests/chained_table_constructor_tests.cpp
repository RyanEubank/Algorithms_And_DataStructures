...
namespace collection_tests {
	...
	// Test the generic implementation for sequential/associative chain types
	// and the specializations with forward list/linked list chains
	...
	using test_params = testing::Types<
		...
		ChainedHashSet<float>,          // defaults same as above, but with float
		ChainedHashSet<void*>,			// ''
		ChainedHashSet<std::string>,	// ''

		// Hash tables with dynamic arrays as chains are ill formed because kev_value_pair<const __, __> is not assignable making the array unable to shift elements when needed
		//ChainedHashMap<uint8_t, std::string, std::hash, std::modulus, std::equal_to, std::allocator, DynamicArray<key_value_pair<const uint8_t, std::string>>>
		...
		ChainedHashMultiSet<uint8_t, std::hash, std::modulus, std::equal_to, std::allocator, DynamicArray<uint8_t>>,
		...
		//ChainedHashMultiMap<uint8_t, std::string, std::hash, std::modulus, std::equal_to, std::allocator, DynamicArray<key_value_pair<const uint8_t, std::string>>>,
